import sys
print(__name__)
print(sys.modules.get("app"))

import flask
from flask import request, send_file
from app import app
print("APP ID IN USER_CONTROLLER =", id(app))
...
def get_avatar(uid):
    ...
    print("ROOT =", root_dir)
    print("AVATAR =", data['payload'][0]['avatar'])
...
print("ROUTES REGISTERED IN USER_CONTROLLER:", app.url_map)